...
void utest1(void)
{
    ...
    char s2[30]="....3D45......................";
    char s3[30]="...  3456.789 ................";
    a=str2num(s1,0,0);   assert(a==0.0);
    a=str2num(s1,30,10); assert(a==0.0);
    a=str2num(s1,10,0);  assert(a==0.0);
    a=str2num(s1,-1,10); assert(a==0.0);
    a=str2num(s1,0,3);   assert(a==123.0);
    a=str2num(s1,10,6);  assert(a==123456.0);
    a=str2num(s1,28,10); assert(a==90.0);
    a=str2num(s2,4,4);   assert(a==3E45);
    a=str2num(s3,4,8);   assert(a==3456.78);
...
void utest2(void)
{
    ...
    s=str2time(s1,4,17,&t); time2epoch(t,ep);
        assert(!s&&ep[0]==2004&&ep[1]==1&&ep[2]==1&&ep[3]==0&&ep[4]==1&&ep[5]==2.34);
    s=str2time(s2,4,21,&t); time2epoch(t,ep);
        assert(!s&&ep[0]==2000&&ep[1]==2&&ep[2]==3&&ep[3]==23&&ep[4]==59&&ep[5]==59.999);
...
void utest3(void)
{
    ...
    t=epoch2time(ep1); time2epoch(t,ep);
        assert(ep[0]==2004&&ep[1]==2&&ep[2]==28&&ep[3]==2&&ep[4]==0&&ep[5]==59.999999);
...
void utest7(void)
{
    ...
    t=gpst2utc(epoch2time(ep1)); time2epoch(t,ep);
        assert(ep[0]==1992&&ep[1]==6&&ep[2]==30&&ep[3]==23&&ep[4]==59&&ep[5]==59.999999);
    ...
    t=gpst2utc(epoch2time(ep4)); time2epoch(t,ep);
        assert(ep[0]==2004&&ep[1]==12&&ep[2]==31&&ep[3]==23&&ep[4]==59&&ep[5]==46.999999);
    ...
    t=gpst2utc(epoch2time(ep6)); time2epoch(t,ep);
        assert(ep[0]==2037&&ep[1]==12&&ep[2]==31&&ep[3]==23&&ep[4]==59&&ep[5]==45.0);
